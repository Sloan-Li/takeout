  ...
  <div v-if="seller" class="header">
    ...
    <div class="detail" v-show="showDetail">
      <div class="detail-main">
        <div class="title" v-text="seller.name"></div>
        <div class="level">
        ...
        <div class="detail-bulletin">
          ...
          <div class="bulletin-text" v-text="seller.bulletin"></div>
        </div>
      </div>
...
.ion-brand {
  ...
  width: 30px;
  height: 16px;
  background: url("../assets/img/brand@2x.png") no-repeat top center;
...
.guarantee {
  background: url("../assets/img/guarantee_3@2x.png");
}
...
.bulletin-wrapper .bulletin-title {
  ...
  width: 22px;
  height: 12px;
  background: url("../assets/img/bulletin@2x.png") no-repeat;
  background-size: 100% 100%;
  vertical-align: top;
  margin-top: 7px;
}
