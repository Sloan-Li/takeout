      ...
      <div class="score-box">
        <div class="score-item">
          ...
          <div class="seller-data">
            {{ seller.minPrice }}<span class="small-word">元</span>
          </div>
        </div>
        <div class="score-item score-border">
          <span class="data-title">商家配送</span>
          <div class="seller-data">
            {{ seller.deliveryPrice }}<span class="small-word">元</span>
          </div>
        </div>
        <div class="score-item">
          <span class="data-title">平均配送时间</span>
          <div class="seller-data">
            {{ seller.deliveryTime }}<span class="small-word">分钟</span>
          </div>
        </div>
      </div>
    </div>
